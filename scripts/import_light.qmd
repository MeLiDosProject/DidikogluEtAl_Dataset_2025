...
Study_dates <- read_excel("../data/Study_dates_MeLiDos_IZTECH.xlsx")
...
grand_overview(coordinates[[site]], cities[[site]], countries[[site]], 
               country_colors[[site]], map_site_label_color = "white")
